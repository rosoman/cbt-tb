...
<section class="content-header">
	...
	<div class="callout callout-info">
                <h1><font color="red">Informasi Anu Anyar</font></h1>
                <p>Data Tes yang lama tidak akan tampil di ujian siswa, jika rentang waktu sudah lewat. Ga di hapus juga ga apa apa, buat arsip ajah.</p>
            </div>
	<ol class="breadcrumb">
