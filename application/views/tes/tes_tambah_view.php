...
<section class="content-header">
	...
	<div class="callout callout-info">
                <h1><font color="red">Informasi Anu Anyar Deui</font></h1>
                <p>Kolom inputnya udah di isiin sebagian, lumayan buat mempercepat bikin jadwal ujiannya</p>
            </div>
	<ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Nilai per 1 Soal</label>
                            <div class="col-sm-9">
