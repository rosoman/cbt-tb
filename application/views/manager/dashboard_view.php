...
<section class="content">
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif Aplikasi Ujian Berbasis Komputer, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian berbasis komputer.</p>
    </div>
	<div class="callout callout-info">
                <h1><font color="red"><b>NEW INFORMATION</b></font> &#128512 </h1>
                <p>Kolom nilai/poin hasil ujian siswa telah dihilangkan pada akun semua pengawas. Hanya kolom nilai/poin saja yang dihilangkan. Untuk menghindari sharing nilai kepada siswa secara langsung oleh pengawas.</p>
            </div>
    <div class="box">
