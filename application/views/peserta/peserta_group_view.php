        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Tambah Kelas</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <p>NB : Kelas digunakan untuk mengelompokkan setiap user</p>
                        </div>
                    </div>
                </div>
    ...
    <?php echo form_open($url.'/edit','id="form-edit"'); ?>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                    <div id="trx-judul">Edit Kelas</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <p>NB : Kelas yang dihapus, maka semua data user akan ikut terhapus !</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
