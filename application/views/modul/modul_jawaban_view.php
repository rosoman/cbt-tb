...
<section class="content">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-footer">
                    <p><Font color="Green">Mengelola jawaban berdasarkan soal yang dipilih. Jika sudah selesai, silahkan kembali ke halaman Soal dengan menutup jendela ini atau memilih menu Soal</Font></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                            <div class="box-title">Daftar Jawaban Yang Sudah Di Input</div>
                    </div><!-- /.box-header -->
