...
<html>
  <head>
    <meta charset="UTF-8">
    <title>CBT | SMK Taruna Bangsa</title>
  ...
  <body class="skin-green layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="<?php echo base_url(); ?>" class="navbar-brand"> <b>CBT | SMK Taruna Bangsa</b></a>
            </div>
      ...
      <!-- Full Width Column -->
      <div class="content-wrapper" style="background-image: url('<?php echo base_url(); ?>public/images/smkbisa.png');">
            <?php 
            if(!empty($content)){
                echo $content; 
            }
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          <center><strong>CBT | SMK TARUNA BANGSA</strong></center>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
