<div class="container">
    ...
    <section class="content-header">
    	<h1>
            ...
            <small>di <?php if(!empty($site_name)){ echo $site_name; } ?></small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="callout callout-info">
            <h4>Informasi</h4>
            <p>Silahkan pilih Tes yang diikuti dari daftar tes yang tersedia dibawah ini. Apabila tes tidak muncul, silahkan menghubungi Pengawas yang bertugas.</p>
        </div>
