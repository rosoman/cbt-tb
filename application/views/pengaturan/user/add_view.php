            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- NGERUBAH INI BUAT ADA KELAS DI OPSI 2 -->
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Opsi 2</label>
                            <div class="col-sm-9">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" id="opsi2" name="opsi2" placeholder="Daftar kelas yang akan dikelola Pengawas" readonly="">
                                    <span class="input-group-btn">
